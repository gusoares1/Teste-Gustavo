  ...
  <body>
        <div class="jmodal modal">
                ...
                <a class="jmodalfechar modal-fechar" href="">X</a>
                    <div>
                        <p class="modal-txt">
                            <label for="medico">Nome Pacoente</label>
    ...
    <div class="container theme-showcase" role="main">
        ...
        <div id="dvBase" >    
            <div class="links">
                <button id="medico" class="jmodalabrir link-tu-cadastrar" href="" type="submit" title="Abrir" value="cadastrar">Cadastrar Paciente</button>
            </div>
        </div><br>
          ...
          <div class="col-md-6">
            <table class="table">
              ...
              <tbody>
                ...
                $sel = $Medico->select('*','cliente','',array());    
